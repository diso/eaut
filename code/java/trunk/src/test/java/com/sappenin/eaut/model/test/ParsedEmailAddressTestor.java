 ...
 * 
 */
public class ParsedEmailAddressTestor extends TestCase
{
	...
	protected void setUp() throws Exception
	{
		...
		pae1 = new ParsedEmailAddressImpl();
		pae1.setLocalPart("user");
		pae1.setDomain("example.com");

		pae2 = new ParsedEmailAddressImpl();
	...
	{
		ParsedEmailAddress pae = ParsedEmailAddressImpl.parse("beth@example.com");
